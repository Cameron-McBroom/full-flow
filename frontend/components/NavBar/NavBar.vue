    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg">
      ...
      <div class="block md:hidden">
        <div class="flex gap-2">
          <a id="mobile-call-btn" class="px-2 py-1 text-cblue" :href="'tel:+61' + $store.state.global.contactNumber.slice(1)">
            <font-awesome-icon :icon="faPhone"/>
          </a>

          <a id="mobile-text-btn" class="px-2 py-1 text-cblue" :href="'sms:+61' + $store.state.global.contactNumber.slice(1)">
